        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!pass.equals(confirmPass)) {
                    Toast.makeText(sign_up_screen.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(sign_up_screen.this, "User registered successfully", Toast.LENGTH_SHORT).show();
